        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?php echo base_url(); ?>create-category" method="post" enctype="mutipart/form-data">
                    <p>Category name</p>
                    <p><input type="text" name="name"></p>
                    <p><input type="submit" name="save" value="Submit" class="btn btn-outline-primary"></p>
                    </form>
                </div>
                <!-- /.container-fluid -->
