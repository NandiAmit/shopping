...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
       <?php $this->load->view("inc/menubar"); ?>
        <!-- End of Sidebar -->
                        ...
                        <tbody>
                          <?php foreach($row as $r){ ?>
                            ...
                            <tr>
                                ...
                                <td><a onclick="return confirm('Are you Sure');" href="<?php echo base_url(); ?>delete-category/<?php echo $r->id ?>"class="btn btn-outline-danger">Delete</a></td>
                                <td><a href="<?php echo base_url(); ?>update-category/<?php echo $r->id; ?>" class="btn btn-outline-warning">Update</a></td>
                            </tr>
