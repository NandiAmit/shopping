    ...
    <div class="col-3 pt-5">
      <div >
        <ul class="list-group ">
          ...
          <li class="list-group-item"><a href="<?php echo base_url(); ?>category/<?php echo base64_encode($c->id); ?>"><?php echo $c->name; ?></a></li>
          ...
          <div class="card" >
            ...
            <div class="card-body">
              ...
              <form action="cart" method="post">
                ...
                <input type="hidden" name="price" value="<?php echo $p->pprice; ?>">
                <p><input type="number" style="width:50px" name="quantity" min="1" value="1"></p>
                <input type="submit" name="save" value="Add to Cart" class="btn btn-primary">
              </form>
            </div>
          </div>
        </div>
