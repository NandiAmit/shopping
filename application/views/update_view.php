            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php foreach($row as $r){ ?>
                        <form action="<?php echo base_url(); ?>upd-category" method="post" enctype="mutipart/form-data">
                            <p>Category name</p>
                            <p><input type="text" name="name" value="<?php echo $r->name; ?>"></p>
                            <p><input type="hidden" name="id" value="<?php echo $r->id; ?>"></p>
